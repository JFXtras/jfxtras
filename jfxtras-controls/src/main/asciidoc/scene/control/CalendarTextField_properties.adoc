...
There are some properties available on the default skin:
-fxx-immediate:[YES|NO] In time mode, this removes the cancel button and immediately writes the value in the popup to the textfield.